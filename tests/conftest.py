...
# WARNING: Ensure imports from `my_python_template_2` comes after this line
from my_python_template_2 import app, settings, db  # noqa
from my_python_template_2.cli import create_user, cli  # noqa
